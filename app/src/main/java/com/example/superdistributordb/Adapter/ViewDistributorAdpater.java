...
import com.example.superdistributordb.Activity.ViewRetailerActivity;
...
public class ViewDistributorAdpater extends RecyclerView.Adapter<ViewDistributorAdpater.ViewHolder> {

    private Context context;
    private List<View_User_Model> user_models;
    private User user;

    public ViewDistributorAdpater(Context context, List<View_User_Model> user_models) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.binding.btnView.setText("View Retailer");
        ...
        holder.binding.btnView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                context.startActivity(new Intent(context, ViewRetailerActivity.class).putExtras(b));
            }
        });
